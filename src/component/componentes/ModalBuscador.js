...
const ModalBuscador = ({ isOpen, onRequestClose, contentLabel, pokemon, onClose }) => {

  // Verificar si pokemon es null o undefined
  if (!pokemon) {
    return (
      <Modal show={isOpen} onHide={onRequestClose} aria-labelledby={contentLabel} backdrop="static" centered>
        <Modal.Header closeButton className='ModalHeaderFooter'>
          <Modal.Title></Modal.Title>
        </Modal.Header >
        <Modal.Body lassName='ModalBody'>
  ...
  return (
    <Modal show={isOpen} onHide={onRequestClose} aria-labelledby={contentLabel} backdrop="static" centered size={'lg'}>
<Modal.Header closeButton className='ModalHeaderFooter'>
